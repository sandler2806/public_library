...
public class RemoveCopiesAdapter extends BaseAdapter {
    ...
    public RemoveCopiesAdapter(Context c, ArrayList<Book> books, ArrayList<String> booksKey) {
        this.books = books;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {//called for each items
        ...
        View v = mInflater.inflate(R.layout.remove_copies_detail, null);
